...
func (suite *IntegrationTestSuite) TestPlayMoveCannotPayFails() {
	...
	suite.Require().Equal("black cannot pay the wager: spendable balance 10000000stake is smaller than 10000001stake: insufficient funds", err.Error())
}
...
func (suite *IntegrationTestSuite) TestPlayMove2CannotPayFails() {
	...
	suite.Require().Nil(playMoveResponse)
	suite.Require().Equal("red cannot pay the wager: spendable balance 10000000stake is smaller than 10000001stake: insufficient funds", err.Error())
}
